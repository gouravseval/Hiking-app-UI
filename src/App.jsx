    ...
    <>
      ...
      <div className="page2 position-relative">
        ...
        <div style={{ height: "50vh", width: "100vw" }} className='flex-wrap mt-2 d-flex align-items-center justify-content-center gap-5 '>
          <Page2Section img={"../assets/page2bag.png"} h1={"Activities"} />
          <Page2Section img={"../assets/page2men.png"} h1={"Hiking"} />
          <Page2Section img={"../assets/page2mountain.png"} h1={"Mountains"} />
        </div>
      </div>
      {/* page2end */}
      ...
      <div className="page5 flex-wrap flex-md-nowrap px-md-5 d-flex justify-content-center align-items-center position-relative">
        ...
        <div style={{minWidth: "350px", width: '40vw' }} className='w-100  mx-md-5 px-md-5'>
          ...
          <Page5section img={"../assets/page2bag.png"} />
          <Page5section img={"../assets/page2mountain.png"} />
          <Page5section img={"../assets/page2men.png"} />
        </div>
      ...
      <div className="page7">
        ...
        <div className='d-flex align-items-center  justify-content-center' style={{ height: "50vh", width: "100vw", gap: "10vw" }}>
          <Page7section img={"../assets/page7pic1.png"} h1={"National Park"} />
          <Page7section img={"../assets/page7pic2.png"} h1={"Mountain Loop"} />
          <Page7section img={"../assets/page7pic3.png"} h1={"Canyan Trail"} />
        </div>
      </div>
      {/* page 7 end */}
